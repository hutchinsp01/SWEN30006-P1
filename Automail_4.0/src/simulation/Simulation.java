...
public class Simulation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /** Install the modem & turn on the modem **/
     	...
     	/** Set up Maintenance cost */
     	HashMap<RobotType, Double> maintenanceCosts = new HashMap<RobotType, Double>();
     	maintenanceCosts.put(RobotType.REG, 0.025);
     	maintenanceCosts.put(RobotType.FAST, 0.05);
     	maintenanceCosts.put(RobotType.BULK, 0.01);
         ...
         */
     	...
     	/** Instantiate ChargeFee */
     	int num_floors = Integer.parseInt(configuration.getProperty(Configuration.N_FLOORS_KEY));
     	int lowest_floor = Integer.parseInt(configuration.getProperty(Configuration.LOWEST_FLOOR_KEY));
     	boolean feeCharging = Boolean.parseBoolean(configuration.getProperty(Configuration.FEE_CHARGING_KEY));
     	ChargeFee chargeFee = new ChargeFee(lowest_floor, num_floors, feeCharging, wifiModem, maintenanceCosts);
        ...
        Automail automail = new Automail(mailPool, iMailDelivery, chargeFee, num_regular_robots, num_fast_robots, num_bulk_robots);
